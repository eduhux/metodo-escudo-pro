...
export const site = {
  nome: "Método Escudo PRO",
  tagline: "Do zero ao avançado no CorelDRAW",
};
...
export const hero = {
  ...
  subheadline:
    "Um método passo a passo, construído a partir de mais de 100 escudos reais, que leva você do primeiro traço ao escudo profissional no CorelDRAW. Feito para quem está começando agora.",
...
export const oferta = {
  ...
  itens: [
    ...
    { nome: "Bônus: pack com 120 escudos PNG de referência", valor: "R$ 39,90" },
    { nome: "Bônus: mockup de apresentação do escudo", valor: "R$ 29,90" },
    { nome: "Bônus: mockup de camisa personalizável", valor: "R$ 29,90" },
